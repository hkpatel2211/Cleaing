<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gardenservices.html.cs" Inherits="Cleaing.gardenservices" %>
...
<body>
    ...
    <!-- Navbar End -->
        ...
        <!-- Page Header Start -->
        <section class="hero-wrap hero-wrap-2" style="background-image: url('logo/g2.jpg'); height:600px;"">
            <div class="overlay"></div>
            <div class="container">
              <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <br />
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="home.aspx">Home <i class="fa fa-chevron-right"></i></a></span> <span>Garden Maintenance <i class="fa fa-chevron-right"></i></span></p>
                  <h1 class="mb-0 bread">Garden Maintenance</h1>
                </div>
              </div>
            </div>
          </section>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <a class="btn" href="lwancare.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <a class="btn" href="weeding.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                       
                        <h4 class="mb-3">Hedge and Bush Trimming </h4>
                        <a class="btn" href="hedge.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                        ...
                        <h4 class="mb-3">Patio & deck Cleaning</h4>
                        <a class="btn" href="patio.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-light rounded h-100 p-5">
                       
                        <h4 class="mb-3">Pressure Washing</h4>
                        <a class="btn" href="pressurewashing.aspx"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                    </div>
                </div>
