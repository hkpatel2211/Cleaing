<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contacttable.aspx.cs" Inherits="Cleaing.contacttable" %>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ContactID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CleaingConnectionString2 %>" ProviderName="<%$ ConnectionStrings:CleaingConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [tbl_ContactUs]"></asp:SqlDataSource>
