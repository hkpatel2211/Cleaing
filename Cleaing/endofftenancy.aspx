<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="endofftenancy.aspx.cs" Inherits="Cleaing.End___off_tetency" %>
...
<body>
    ...
    <!-- Page Header Start -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('logo/e1.jpeg'); height:800px; " ">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <br />
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="home.aspx">Home <i class="fa fa-chevron-right"></i></a></span> <span>End-off tenancy Cleaning<i class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">End-off Tenancy Cleaning</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        ...
                        <br />
                        <br />
                        <img class="img-fluid rounded w-75 align-self-end" src="logo/e3.jpeg" alt="">
                        <img class="img-fluid rounded w-75 bg-white pt-3 pe-3" src="logo/e2.jpeg" alt="" style="margin-top: -25%;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="d-inline-block border rounded-pill py-1 px-4">End-off Tenancy cleaning </p>
 <h1 class="text-black mb-4">End of Tenancy Cleaning in London</h1>
                        <p class="text-black mb-4 pb-2">An end of lease cleaning includes bond cleaning, vacuuming all carpets, mopping the floors, thorough dusting of any hard furniture, cleaning the kitchen, vacate cleaning, bathrooms, the oven inside and out, as well as cleaning the windows. The cleaning team uses professional equipment and detergents and follows detailed end-of-lease cleaning services.</p>
                      ...
                      <p>Our primary motive is to provide a 100% deposit back through our end-of-lease cleaning in london. That’s why our experts don’t just ‘try to clean’, instead they are motivated to clean all and any kind of dirt, stains, and stubborn marks.</p>
                        <br />
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="text-container">
                    <br />
                    <br />
                      <p class="text-black mb-4 pb-2">We, at 365 Cleaners, offer a wide range of services for end of tenancy house cleaning across London. Some of our services include:
                </p>
                          <ul>
                              <li>
                              ...
                              <li>
                                  Cleaning of cupboards, drawers, and other storage units in every room.</li>
<li>Cleaning and degreasing of all the tiles.</li>
<li>Vacuum cleaning of the carpets.</li>
<li>Cleaning of the ceiling and cornices.</li>
<li>Washing and polishing of the mirrors.</li>
<li>Elimination of all the unimportant and old stuff.</li>
<li>Thorough cleaning of the wooden furniture.</li>
<li>Cleaning and disinfecting of the toilets.</li>
<li>Washing off all the kitchen equipment and appliances.</li>
<li>Proper cleaning of the waste disposal containers.</li>
                          </ul>
            ...
            <div class="col-6">
                <div class="image-">
                    <br />
                    <br />
                    <img src="logo/d3.jpg" alt="Image 1" style="height:100%;width:100%;">
                </div>
                <br />
                <br />
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-container">
                    ...
                    <h1 style="text-align:center">Book  End-of Tenancy Cleaning  </h1>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                    &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
